...
export default function ItemCount({stock = 0}) {
    ...
    return (
        <div className="d-flex justify-content-center">
            <button className="btn btn-outline-dark m-1" onClick={HandleSubstrac} disabled={count<=0}>-</button>
            <p className="p-1">{count}</p>
            <button className="btn btn-outline-dark m-1" onClick={HandleAdd} disabled={count>=stock}>+</button>
